...
$payment_statuses = [
    'new'     => 'Новий (не оплачений)',
    'timeout' => 'Новий (не оплачений)',
    'success' => 'Успішний',
    'error'   => 'Помилка',
    'reverse' => 'Cторнований',
    'pending' => 'В обробцi',
...
$MONTHS_NAME = [
     1 => ['en' => 'January',   'ua' => ['short' => 'січ', 'big' => 'Січень',   'small' => 'січень'],   'ru' => ['big' => 'Январь',   'small' => 'январь']],
     2 => ['en' => 'February',  'ua' => ['short' => 'лют', 'big' => 'Лютий',    'small' => 'лютий'],    'ru' => ['big' => 'Февраль',  'small' => 'февраль']],
     3 => ['en' => 'March',     'ua' => ['short' => 'бер', 'big' => 'Березень', 'small' => 'березень'], 'ru' => ['big' => 'Март',     'small' => 'март']],
     4 => ['en' => 'April',     'ua' => ['short' => 'кві', 'big' => 'Квітень',  'small' => 'квітень'],  'ru' => ['big' => 'Апрель',   'small' => 'апрель']],
     5 => ['en' => 'May',       'ua' => ['short' => 'тра', 'big' => 'Травень',  'small' => 'травень'],  'ru' => ['big' => 'Май',      'small' => 'май']],
     6 => ['en' => 'June',      'ua' => ['short' => 'чер', 'big' => 'Червень',  'small' => 'червень'],  'ru' => ['big' => 'Июнь',     'small' => 'июнь']],
     7 => ['en' => 'July',      'ua' => ['short' => 'лип', 'big' => 'Липень',   'small' => 'липень'],   'ru' => ['big' => 'Июль',     'small' => 'июль']],
     8 => ['en' => 'August',    'ua' => ['short' => 'сер', 'big' => 'Серпень',  'small' => 'серпень'],  'ru' => ['big' => 'Август',   'small' => 'август']],
     9 => ['en' => 'September', 'ua' => ['short' => 'вер', 'big' => 'Вересень', 'small' => 'вересень'], 'ru' => ['big' => 'Сентябрь', 'small' => 'сентябрь']],
    10 => ['en' => 'October',   'ua' => ['short' => 'жов', 'big' => 'Жовтень',  'small' => 'жовтень'],  'ru' => ['big' => 'Октябрь',  'small' => 'октябрь']],
    11 => ['en' => 'November',  'ua' => ['short' => 'лис', 'big' => 'Листопад', 'small' => 'листопад'], 'ru' => ['big' => 'Ноябрь',   'small' => 'ноябрь']],
    12 => ['en' => 'December',  'ua' => ['short' => 'гру', 'big' => 'Грудень',  'small' => 'грудень'],  'ru' => ['big' => 'Декабрь',  'small' => 'декабрь']],
];
...
$MONTHS = [
     ...
     4 => ['ru' => 'апреля',   'en' => 'April',     'ua' => 'квітня'],
...
$MONTHS_WHEN = [
     ...
     4 => ['ru' => 'апреля',   'en' => 'April',     'ua' => 'квітні'],
