<div class="form-block left">
    ...
    <div class="input">
        <label>По-батьковi <br>
            <input onblur="registration_ckeck_empty_fileld(this);" required="required" class="txt form-txt-input" type="text" name="fathername" id="reg-fathername" value="<?= htmlspecialchars($__userData['fathername'], ENT_QUOTES); ?>">
        </label>
        <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнiм</div>
    </div>
    <div class="input">
