            ...
            switch ($_SESSION['instant-payments-requisites']['step']) {
                ...
                default:
                    ...
                    <form class="feedback-form" method="post" action="<?= BASE_URL; ?>/post/cabinet/instant-payments/requisites/">
                        ...
                        <div style="display: inline-block; float: none; width: 100%;">
                            <div class="form-group" style="display: inline-block; float: left; margin-right: 61px;">
                                <label>
                                    ...
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($firme, ENT_QUOTES); ?>" type="text" name="firme" class="form-txt" required="required">
                                </label>
                            ...
                            <div class="form-group" style="display: inline-block;">
                                <label>
                                    ...
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($mfo, ENT_QUOTES); ?>" type="text" name="mfo" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                        </div>
                        ...
                        <div style="display: inline-block; float: none; width: 100%;">
                            <div class="form-group" style="display: inline-block; float: left; margin-right: 61px;">
                                <label>
                                    ...
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($bank, ENT_QUOTES); ?>" type="text" name="bank" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                            <div class="form-group" style="display: inline-block;">
                                <label>
                                    ...
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($account, ENT_QUOTES); ?>" type="text" name="account" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                        </div>
                        ...
                        <div style="display: inline-block; float: none; width: 100%;">
                            <div class="form-group" style="display: inline-block; margin-right: 61px;">
                                <label>
                                    <?= $keys['okpo']; ?> <span class="star-required" title="Обов’язкове поле">*</span> <br>
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($okpo, ENT_QUOTES); ?>" type="text" name="okpo" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                        </div>
                        ...
                        <div style="display: inline-block; float: none; width: 100%;">
                            <div class="form-group" style="display: inline-block; margin-right: 61px;">
                                <label>
                                    ...
                                    <input style="width: 655px;" onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($dest, ENT_QUOTES); ?>" type="text" name="dest" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                        </div>
                        ...
                        <div style="display: inline-block; float: none; width: 100%;">
                            <div class="form-group" style="display: inline-block; float: left; margin-right: 61px;">
                                <label>
                                    ...
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($lastname, ENT_QUOTES); ?>" type="text" name="lastname" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                            ...
                            <div class="form-group" style="display: inline-block;">
                                <label>
                                    ...
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($firstname, ENT_QUOTES); ?>" type="text" name="firstname" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                        </div>
                        <div style="display: inline-block; float: none; width: 100%;">
                            ...
                            <div class="form-group" style="<?= $display_email; ?>">
                                <label>
                                    ...
                                    <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($email, ENT_QUOTES); ?>" type="email" name="email" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                        </div>
                        ...
                        <div style="display: inline-block; float: none; width: 100%;">
                            <div class="form-group full-width">
                                <label>
                                    ...
                                    <input style="width: 655px;" onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($address, ENT_QUOTES); ?>" type="text" name="address" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                        </div>
                        ...
                        <div style="display: inline-block; float: none; width: 100%;">
                            <div class="form-group" style="display: inline-block; float: left; margin-right: 61px;">
                                <label>
                                    ...
                                    <input id="p2p-phone" onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($phone, ENT_QUOTES); ?>" type="text" name="phone" class="form-txt" required="required">
                                </label>
                                <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                            </div>
                            <div class="form-group" style="display: inline-block;">
