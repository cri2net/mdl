            ...
            default:
                ...
                <form class="feedback-form" method="post" action="<?= BASE_URL; ?>/post/cabinet/instant-payments/budget/">
                    ...
                    <div style="display: inline-block; float: none; width: 100%;">
                        <div class="form-group">
                            <label>
                                ...
                                <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($lastname, ENT_QUOTES); ?>" name="lastname" class="form-txt txt-full" required="required" type="text">
                            </label>
                            <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                        </div>
                        <div class="form-group">
                            <label>
                                ...
                                <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($name, ENT_QUOTES); ?>" name="name" class="form-txt txt-full" required="required" type="text">
                            </label>
                            <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                        </div>
                        <div class="form-group">
                            <label>
                                ...
                                <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($inn, ENT_QUOTES); ?>" name="inn" class="form-txt txt-full" required="required" type="text">
                            </label>
                            <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                        </div>
                        <div class="form-group">
                            <label>
                                ...
                                <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($address, ENT_QUOTES); ?>" name="address" class="form-txt txt-full" required="required" type="text">
                            </label>
                            <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                        </div>
                        <?php
                        ...
                        <div class="form-group" style="<?= $display_email; ?>">
                            <label>
                                ...
                                <input onblur="registration_ckeck_empty_fileld(this);" value="<?= htmlspecialchars($email, ENT_QUOTES); ?>" name="email" class="form-txt txt-full" required="required" type="text">
                            </label>
                            <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                        </div>
                    </div>
                    ...
                    <div style="display: inline-block; float: none; width: 100%;">
                        <div class="form-group">
                            <label>
                                <input onblur="registration_ckeck_empty_fileld(this);" maxlength="8" value="<?= htmlspecialchars($summ, ENT_QUOTES); ?>" name="summ" class="form-txt" required="required" type="text">
                            </label>
                            <div style="display:none;" class="error-text"><div class="error-icon"></div> поле не повинно бути порожнім</div>
                        </div>
                    </div>  
