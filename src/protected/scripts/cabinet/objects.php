                                ...
                                <div class="info-section card__wrapper">
                                    <div class="card__title">
                                        <?php
                                            if ($flat['title']) {
                                                ?>
                                                <a href="<?= BASE_URL; ?>/cabinet/objects/<?= $flat['id']; ?>/" class="card__address card__title"><?= htmlspecialchars($flat['title']); ?></a>
                                    ...
                                    ?>
                                    <span class="align-center"><a href="<?= BASE_URL; ?>/cabinet/objects/<?= $flat['id']; ?>/" class="btn button button__form button__form--card">Перейти до об’єкту</a></span>
                                </div>
                                <div class="remove-section card__remove">
                                    <p class="card__remove-text">Ви впевнені, що хочете видали цей об’єкт з аккаунту?</p>
                                    <a href="#" class="btn btn-orange remove-object button button__form button__form--remove button__form--registration" data-object-id="<?= $flat['id']; ?>">Видалили</a>
                                    <a href="#" class="btn btn-green-bordered remove-object-cancel button button__form button__form--remove button__form--registration">Скасувати</a>
                                </div>
                            </div>
                        </div>
                        <?php
