...
<table <?= $_table_attr; ?>><tbody><tr><td>
    ...
    <table <?= $_table_attr; ?>><tbody><tr>
        <td width="222" bgcolor="#eeeeee" style="padding-bottom:27px; padding-top:27px; padding-left:18px; padding-right:11px;"><img src="<?= $__img_path; ?>paysystems.png" alt="мы принимаем к оплате" height="25" width="222" hspace="0" vspace="0" border="0"></td>
