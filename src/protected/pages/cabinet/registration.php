        ...
        <form onsubmit="registration_form_submit();" method="post" action="<?= BASE_URL; ?>/post/cabinet/registration/">
            ...
            <div class="input" style="height:40px; line-height:15px; font-size:12px; color:#444;">
                <div style="position:absolute; width:750px;">
                    Реєструючись, Ви підтверджуєте свою згоду на обробку персональних даних, а також підтверджуєте те, що ознайомились та погоджуєтесь зі <a href="<?= BASE_URL; ?>/help/offers/">Згодою користувача</a> та <a href="<?= BASE_URL; ?>/help/offers/">Згодою на збір та обробку персональних даних</a>
                </div>
            </div>
            <div class="input">
